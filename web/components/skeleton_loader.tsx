...
export const DashboardLoader = () => (
  <div className="m-8 relative">
    {/* Dashboard Navigation Section (Skeleton) */}
    <div className="sticky top-0 z-50 bg-white/10 rounded-lg p-4 flex items-center justify-between animate-pulse">
      <div className="flex items-center">
        <div className="h-6 w-20 bg-gray-300 rounded-md mb-2"></div>
      </div>
      <div className="flex items-center space-x-4">
        <div className="h-8 w-32 bg-neutral-500 rounded-md"></div>
        <div className="h-8 w-20 bg-red-500 rounded-md"></div>
      </div>
    </div>

    {/* Conditional rendering based on user status (Skeleton) */}
    <div className="flex flex-col items-center mt-7">
      <div className="animate-spin bg-amber-500 h-10 w-10 mb-5"></div>
      <div className="bg-neutral-500 text-white text-center px-12 py-4 rounded-lg hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue active:bg-neutral-800 mb-4 h-16 w-6 animate-pulse"></div>
      <div className="bg-neutral-500 text-white text-center px-12 py-4 rounded-lg hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue active:bg-neutral-800 h-16 w-64 animate-pulse"></div>
    </div>
  </div>
);
